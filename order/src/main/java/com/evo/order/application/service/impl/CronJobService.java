...
public class CronJobService {
    ...
    public void syncOrderStatus() {
        List<OrderStatus> orderStatuses = Arrays.asList(OrderStatus.PENDING_SHIPMENT, OrderStatus.WAITING_FOR_PICKUP, OrderStatus.DELIVERED);
        ...
        orders.stream()
                ...
                .forEach(order -> {
                    ...
                    GHNOrderDetailDTO ghnOrderDetailDTO = ghnClient.getOrderDetail(getGHNFeeRequest).getData();
                    String ghnStatus = ghnOrderDetailDTO.getLog().getFirst().getStatus();
                    if (ghnStatus != null) {
                        OrderStatus orderStatus = switch (ghnStatus) {
                            ...
                            case "picked", "storing", "transporting", "sorting",
                                 ...
                                 "return_transporting", "return_sorting", "returning" -> OrderStatus.IN_TRANSIT;
