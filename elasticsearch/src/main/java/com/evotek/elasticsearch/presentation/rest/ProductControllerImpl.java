...
public class ProductControllerImpl implements ProductController {
    ...
    @Override
    public PageApiResponse<List<ProductDocumentDTO>> searchProduct(@RequestBody SearchProductRequest request) {
        SearchProductDTO searchProductResponse = this.productQueryService.searchProduct(request);
    ...
    public ApiResponses<List<String>> autocompleteProductNames(
        ...
        return ApiResponses.of(this.productQueryService.autocompleteProductNames(keyword, limit));
    }
}
