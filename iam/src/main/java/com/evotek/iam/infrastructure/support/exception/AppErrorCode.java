...
public enum AppErrorCode {
    FILE_NOT_FOUND(1015, "File not found", HttpStatus.NOT_FOUND),
    PERMISSION_NOT_FOUND(1020, "Permission not found", HttpStatus.NOT_FOUND),
    ...
    USER_ACTIVITY_LOG_NOT_FOUND(1024, "User activity log not found", HttpStatus.NOT_FOUND),
